...
public class InquiryController {
    ...
    @PostMapping("/")
    public ResponseEntity<MakeInquiryResponse> makeInquiry(@Validated @RequestBody MakeInquiryRequest makeInquiryRequest, @RequestHeader("Authorization") String authorizationHeader) {
        return ResponseEntity.ok(inquiryService.makeInquiry(makeInquiryRequest, authorizationHeader));
    }
    ...
    public ResponseEntity<GetInquiryResponse> getInquiry(@PathVariable("id") String id, @RequestHeader("Authorization") String authorizationHeader) {
        return ResponseEntity.ok(inquiryService.getInquiry(id, authorizationHeader));
    }
    ...
    @GetMapping("/myInquirys")
    public ResponseEntity<GetMyInquirysResponse> getMyInquirys(@RequestHeader("Authorization") String authorizationHeader) {
        return ResponseEntity.ok(inquiryService.getMyInquirys(authorizationHeader));
    }
}
